    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="dark-button" href="tel:+251911111111">Order now <span>↗</span></a><a className="text-link" href="#menu">See what’s brewing <span>↓</span></a></div>
        </div>
